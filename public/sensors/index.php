...
<html lang="<?PHP echo $index["system_language"]; ?>">
  <head>
    ...
    <title><?PHP echo $index["system_name"]." | ".lang("sensor_title"); ?></title>
          ...
          <div class="row">
              ...
              <div class="x_panel">
                <div class="row x_title">
                  <div class="col-md-11 col-sm-11 col-xs-10">
                    <h2><?PHP echoLang("sensor_table_title"); ?></h2>
                  </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 x_content">
                  <table id="datatable" class="table table-hover table-striped">
                    <thead>
                      <tr>
                        <th><?PHP echoLang("sensor_table_header_name"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_id"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_key"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_create"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_type"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_unity"); ?></th>
                        <th><?PHP echoLang("sensor_table_header_options"); ?></th>
                      </tr>
                    </thead>
					...
					$query = $connect->query("SELECT id, name, skey, type, unity, screate FROM ".$index["database_table_sensors"])->fetchAll();
					foreach($query as $s) {
						echo '<tr id="'.$s["id"].'">';
						echo '<td>'.$s["name"].'</td>';
						echo '<td class="table_align">
						  <p name="id" class="alignleft">'.$s["id"].'</p>
                          <button name="sensor-copy-id" id="'.$s["id"].'" class="btn btn-link alignleft" data-toggle="tooltip" data-placement="top" title="'.lang("sensor_copy_id").'"><i class="fa  fa-tag"></i></button>
                        </td>';
						echo '<td class="table_align">
						<p name="key" class="alignleft">'.$s["skey"].'</p>
						<button name="sensor-copy-key" id="'.$s["id"].'" class="btn btn-link alignleft" data-toggle="tooltip" data-placement="top" title="'.lang("sensor_copy_key").'"><i class="fa  fa-key"></i></button>
					  </td>';
						echo '<td>'.date("Y/m/d", strtotime($s["screate"])).'</td>';
						switch($s["type"]) {
							case 0: 
                ...
                break;
							default: 
                echo '<td>'.lang("sensor_type_float").'('.(int)substr($s["type"], 1).')</td>';
                echo '<td>'.$s["unity"].'</td>';
                break;
						}
						echo '<td>
                          <button name="sensor-edit" id="'.$s["id"].'" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="'.lang("sensor_edit").'"><i class="fa fa-cogs"></i></button>
                          <button name="sensor-delete" id="'.$s["id"].'" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="'.lang("sensor_delete").'"><i class="fa fa-trash-o"></i></button>
                        </td>';
						echo "</tr>";
					}
            ...
            <div class="col-md-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <div class="col-md-11 col-sm-11 col-xs-10">
                    <h2><?PHP echoLang("sensor_create_title"); ?></h2>
                  </div>
                  <div class="col-md-1 col-sm-1 col-xs-2">
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a title="<?PHP echoLang("panel_button_help"); ?>" class="link" target="_blank" href="<?PHP echo $index["system_url"].$index["loc_page_help"].""; ?>"><i class="fa fa-question"></i></a></li>
                ...
                <div class="x_content">
                  <br />
                  <form class="form-horizontal form-label-left input_mask" name="sensorCreate" method="POST" action="?create">
                    ...
                    <div class="form-side-left col-md-6 col-ms-6 col-xs-12">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-11 col-md-offset-3 col-sm-offset-3 col-xs-offset-1">
                          <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-default" name="create" value="0">
                              <input type="radio" name="type" value="0" required="required"><?PHP echoLang("sensor_type_boolean"); ?>
                            </label>
                            <label class="btn btn-default" name="create" value="1">
                              <input type="radio" name="type" value="1" required="required"><?PHP echoLang("sensor_type_whole"); ?>
                            </label>
                            <label class="btn btn-default" name="create" value="2">
                              <input type="radio" name="type" value="2" required="required"><?PHP echoLang("sensor_type_float"); ?>
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <input type="text" class="form-control has-feedback-left" name="name" id="name-create" placeholder="<?PHP echoLang("sensor_create_name"); ?>" required="required">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input type="text" class="form-control has-feedback-left" name="unity" id="unity-create" placeholder="<?PHP echoLang("sensor_create_unity"); ?>" required="required">
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input type="number" class="form-control has-feedback-left" name="decimal" id="decimal-create" placeholder="<?PHP echoLang("sensor_create_decimal"); ?>" required="required">
                    ...
                    <div class="form-side-right col-md-6 col-ms-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="">
                            <label>
                              <input name="option1" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_1"); ?>
                            </label>
                          </div>
                          <div class="">
                            <label>
                              <input name="option2" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_2"); ?>
                            </label>
                          </div>
                          <div class="">
                            <label>
                              <input name="option3" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_3"); ?>
                            </label>
                          </div>
                          <div class="">
                            <label>
                              <input name="option4" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_4"); ?>
                            </label>
                          </div>
                          <div class="">
                            <label>
                              <input name="option5" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_5"); ?>
                            </label>
                          </div>
                          <div class="">
                            <label>
                              <input name="option6" type="checkbox" class="js-switch" /> <?PHP echoLang("sensor_create_option_6"); ?>
                            </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group col-md-12 col-ms-12 col-xs-12">
                      ...
                      <div class="alignright">
                        <button type="submit" class="btn btn-success right"><?PHP echoLang("sensor_create_button"); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
