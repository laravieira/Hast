...
public class TheLogger {
	...
	public static void load() {
		try {
			...
			Handler[] handlers = Logger.getLogger(Server.class.getCanonicalName()).getParent().getHandlers();
			for(Handler handler : handlers)
				Logger.getLogger(Server.class.getCanonicalName()).getParent().removeHandler(handler);
			...
			consoleLogger = Logger.getLogger(Server.class.getCanonicalName());
